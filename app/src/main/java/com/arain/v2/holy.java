...
public class holy extends AppCompatActivity {
    ...
    private void addSchedule() {
        ...
        // Create a Schedule object with the user's input.
        ...
        newScheduleRef.setValue(schedule, new DatabaseReference.CompletionListener() {
            ...
            public void onComplete(DatabaseError error, @NonNull DatabaseReference ref) {
                if (error != null) {
                    Toast.makeText(holy.this, "Failed to add schedule: " + error.getMessage(), Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(holy.this, "Schedule added successfully", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private ValueEventListener schedulesListener = new ValueEventListener() {
        ...
        public void onDataChange(@NonNull com.google.firebase.database.DataSnapshot dataSnapshot) {
            ...
            for (com.google.firebase.database.DataSnapshot scheduleSnapshot : dataSnapshot.getChildren()) {
                ...
                if (schedule.timestamp > now && schedule.duration > 0) {
                    ...
                    // Schedule a TimerTask to turn the water pump on after the delay.
                    new Timer().schedule(new TimerTask() {
                        ...
                        public void run() {
                            ...
                            // Schedule another TimerTask to turn the water pump off after the duration.
                            new Timer().schedule(new TimerTask() {
                                @Override
                                public void run() {
        ...
        public void onCancelled(@NonNull DatabaseError databaseError) {
            Toast.makeText(holy.this, "Failed to read schedules: " + databaseError.getMessage(), Toast.LENGTH_LONG).show();
        }
    };
